...
// const Header = () => {
//   return (
//     <div className='min-h-screen mb-16 bg-cover bg-center flex items-center w-full overflow-hidden'
...
//                 <a href="#About" className= 'bg-green-400 px-8 py-3 rounded'>About</a>
//             </div>
//         </div>
